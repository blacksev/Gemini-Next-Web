...
const de: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} Nachrichten mit Gemini`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromChatGPT: "Nachricht von Gemini",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Erzwingt das Hinzufügen eines simulierten systemweiten Prompts von Gemini am Anfang der Nachrichtenliste bei jeder Anfrage",
    },
    Update: {
